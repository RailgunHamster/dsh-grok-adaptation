  ...
  const responseBody = new ReadableStream({
    start(controller) {
      ...
      socket.on("close", (code, reason) => {
        ...
        closeNormally();
        // If the socket closes before any terminal event, let the buffered
        // events drain and surface "ended before terminal" naturally from the
        // parser instead of racing a controller error with it.
